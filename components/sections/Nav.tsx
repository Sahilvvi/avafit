  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* AVA Fit is the product name and leads as the title; the Quorum
              mark sits underneath it as the maker's mark, not the other way
              around. */}
          <motion.a
            href="#top"
            className="flex flex-col items-start relative z-10 shrink-0"
            whileHover={{ scale: 1.04 }}
            whileTap={{ scale: 0.96 }}
            transition={{ type: "spring", stiffness: 400, damping: 18 }}
          >
            <span
              className={`font-sans font-bold leading-none tracking-tight text-foreground transition-[font-size] duration-500 ${
